...
$req = "SELECT * FROM champions WHERE id=10";
 
// on envoie la requête
$res = $conn->query($req);
$resi = $conn->query("SELECT * FROM items WHERE id=10");
...
<h1 class='spell-box'>
<img src='../spells/".$data['id']."-".$id5.".png'>
".$dataa5['name']."
</h1>
...
<h1 class='spell-box'>
<img src='../spells/".$data['id']."-".$id1.".png'>
".$dataa1['name']."
</h1>
...
<h1 class='spell-box'>
<img src='../spells/".$data['id']."-".$id2.".png'>
".$dataa2['name']."
</h1>
...
<h1 class='spell-box'>
<img src='../spells/".$data['id']."-".$id3.".png'>
".$dataa3['name']."
</h1>
...
<h1 class='spell-box'>
<img src='../spells/".$data['id']."-".$id4.".png'>
".$dataa4['name']."
</h1>
